...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("địt mẹ mày game này đéo support nhé")
end
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Blue>Hello you is gay<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow><Color=/>"):Display()
    wait(.14)
...
M:AddParagraph("Main Farm","Kwi handsome")
